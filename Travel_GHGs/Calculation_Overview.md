...
| Total passengers (Metric Tonnes CO2e) | 251.1 CO2e | 502.2 CO2e  | 

</div>

Please refer to the [SBS EU Offsetting Implementation Plan](https://github.com/protocol/SBS_EU/blob/main/Travel_GHGs/Offsetting_Implementation_Plan.md) to read about our plan to procure high-quality carbon offsets to match 2X the travel-related emissions (estimated 502.2 CO2e). 
